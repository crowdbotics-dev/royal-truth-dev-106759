"""
Django settings for royal_truth_dev_106759 project.
...
ROOT_URLCONF = 'royal_truth_dev_106759.urls'
...
WSGI_APPLICATION = 'royal_truth_dev_106759.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "royal_truth_dev_106759 API",
    "DESCRIPTION": "API documentation for royal_truth_dev_106759 App",
    "VERSION": "v1",
}
